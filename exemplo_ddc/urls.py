...
from views import HomePageView, FormHorizontalView, FormInlineView, PaginationView, FormWithFilesView, \
    ...
    IndexPageView, PrescriptionPageView, MedicationPageView

urlpatterns = [
    
    url(r'^$', IndexPageView.as_view(), name='index'),
    url(r'^p$', PrescriptionPageView.as_view(), name='prescription'),
    url(r'^m$', MedicationPageView.as_view(), name='medication'),
